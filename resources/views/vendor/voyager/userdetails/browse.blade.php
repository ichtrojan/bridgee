...
<div class="modal-content">
  <p> {{$totalUsers}} users are currently registered on Bridgr</p>
</div>

<div class="modal-content">
  <p> {{$bannedUsers}} users are currently banned on Bridgr</p>
</div>
...
new Chart(document.getElementById("pie-chart"), {
    type: 'pie',
    data: {
      labels: ["Unlimited", "PLC", "LLC", "Private"],
      datasets: [{
        label: "Users",
    ...
    options: {
      title: {
        display: true,
        text: 'Users on Platform by Organization Type'
      }
    }
});
</script>
